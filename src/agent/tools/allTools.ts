...
const readSheetTool = tool(readSheet, {
  name: 'sheet_read',
  description:
    'Lit une cellule du Google Sheet budget. Cellules disponibles : RSA=G2, Loyer=E11, Basic Fit=E12, Netflix=E13, Suno AI=E14, Electricité=E15, Cdiscount Mobile=E16, Total frais fixes=E17, Epargne potentielle=G18, Epargne réel=G19',
  schema: z.object({
...
export const writeSheetTool = tool(writeSheet, {
  name: 'sheet_write',
  description:
    "Ajoute une dépense de courses dans le Google Sheet dédié, après scan d\'un ticket de caisse. Ne pas utiliser rag_add_pdf pour les tickets de caisse. Génère automatiquement la date du jour.",
  schema: z.object({
