...
export const bitWardenLoginTool = tool(getLogin, {
  ...
  description: "Utilise cet outil quand l'utilisateur veut récupérer le login (username) d'une entrée Vaultwarden.",
  schema: z.object({
...
export const bitWardenPasswordTool = tool(getPassword, {
  ...
  description: "Utilise cet outil quand l'utilisateur veut récupérer le mot de passe d'une entrée Vaultwarden.",
  schema: z.object({
    name: z.string().describe("Nom exact de l'entrée Vaultwarden"),
  }),
})
...
export const bitWardenDeleteItemTool = tool(deleteItem, {
  ...
  description: "Utilise cet outil quand l'utilisateur veut supprimer une entrée Vaultwarden.",
  schema: z.object({
