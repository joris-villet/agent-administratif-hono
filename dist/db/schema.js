...
import { boolean, customType, foreignKey, index, integer, json, jsonb, pgTable, serial, text, timestamp, unique, uuid, varchar, vector, } from 'drizzle-orm/pg-core';
...
export const checkpointWrites = pgTable('checkpoint_writes', {
    ...
    unique('checkpoint_writes_unique').on(table.threadId, table.checkpointNs, table.checkpointId, table.taskId, table.idx),
]);
